...
public class PersonaService {
    ...
    public void alta(Scanner sc, Persona[] personas) {
        ...
        if (!sc.hasNextInt()) {
            ...
            if (id <= 0) {
            ...
            } else if (this.existeId(personas, id)) {
                ...
                if (nombre.trim().isEmpty()) {
                    ...
                    if (!sc.hasNextDouble()) {
                        ...
                        sc.nextLine();
                        if (!(promedio < (double)0.0F) && !(promedio > (double)10.0F)) {
    ...
    public void buscar(Scanner sc, Persona[] personas) {
        ...
        for(Persona p : personas) {
            if (p != null && p.getId() == id && p.isActivo()) {
                System.out.println("Resultado: " + String.valueOf(p));
                return;
            }
        }
    ...
    public void reportes(Persona[] personas) {
        ...
        if (contador == 0) {
            ...
            double promedioGeneral = suma / (double)contador;
            System.out.println(" REPORTES ");
            System.out.println("Promedio general: " + promedioGeneral);
            System.out.println("Mayor promedio: " + String.valueOf(mayor));
            System.out.println("Menor promedio: " + String.valueOf(menor));
