...
public class AppController {
    ...
    private void filtrarDatos(String textoBusqueda) {
        ...
        try {
            ...
            // 2. Creamos una lista temporal para guardar los resultados que coincidan
            ObservableList<String> resultadosFiltrados = FXCollections.observableArrayList();


            // 3. Ciclo for nativo para filtrar
            ...
            // 4. Actualizamos el ListView con los resultados encontrados
